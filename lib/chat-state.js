...
module.exports = function createChatState() {
  // ============ AGENTS REGISTRY ============
  const AGENTS = [
    { id: 'lewis', name: 'Lewis', emoji: '📚', sessionKey: 'portal:dm-lewis', avatarUrl: '/assets/lewis-avatar.png' },
    { id: 'marty', name: 'Marty', emoji: '🎯', sessionKey: 'portal:dm-marty', avatarUrl: '/assets/marty-avatar.jpg' },
    { id: 'pascal', name: 'Pascal', emoji: '⚙️', sessionKey: 'portal:dm-pascal', avatarUrl: '/assets/pascal-avatar.jpg' },
    { id: 'milton', name: 'Milton', emoji: '💰', sessionKey: 'portal:dm-milton', avatarUrl: '/assets/milton-avatar.jpg' }
  ];
  ...
  const CHAT_SESSION_KEY = 'portal:dm-lewis';
